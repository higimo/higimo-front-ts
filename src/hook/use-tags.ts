...
// TODO: принимает только примитивы, сложные объекты не умеет обрабатывать, для этого кастомное сравнение надо пробрасывать
// TODO: поддерживать режим «только один выбранный» (радио-кнопка)
