...
// TODO: [MEDIUM] принимает только примитивы, сложные объекты не умеет обрабатывать, для этого кастомное сравнение надо пробрасывать
// TODO: [MEDIUM] поддерживать режим «только один выбранный» (радио-кнопка)
