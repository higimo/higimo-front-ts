...
export const BREADCRUMS_DIC: Record<RouteType, string> = {
	...
	[ROUTE_LINKS.adminIndex]:   'Админка',

	[ROUTE_LINKS.projectIndex]:      'Сделал',
	[ROUTE_LINKS.projectTable]:      'Таблица сделанного',
	[ROUTE_LINKS.projectTypography]: 'Типографика анонса',
	[ROUTE_LINKS.projectSandbox]:    'Сэндбокс',
	...
	[ROUTE_LINKS.comoji]:  'Комоджи (⌐■_■)',
	[ROUTE_LINKS.emailer]: 'Эмайлер',
	[ROUTE_LINKS.magic]:   'Магический шар',
	...
	[ROUTE_LINKS.thingsIndex]:    'Мои вещи',
	[ROUTE_LINKS.thingsNotebook]: 'Ноутбук',
	[ROUTE_LINKS.thingsVelo]:     'Велосипед',

	[ROUTE_LINKS.gameIndex]: 'Настольные игры',
	[ROUTE_LINKS.igLink]:    'Главные ссылки',

	[ROUTE_LINKS.learningIndex]: 'Обучение',
