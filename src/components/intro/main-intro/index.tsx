...
export const MainIntro: FunctionComponent = () => (
	<PrecentationContainer className="main-intro">
		<TextContainer>
			...
			<p>
				Ранее руководил продуктом <a href={EXTERNAL_LINKS.superjob} class="nowrap"><CompanyLogo name="SJ" /> Суперджоба</a>, до этого строил там же магию на <span class="nowrap">на <a href={EXTERNAL_LINKS.reactJs}>Реакте</a></span>. В прошлой жизни был разработчиком в <span class="nowrap"><a href={EXTERNAL_LINKS.afishaDaily} class="nowrap"><CompanyLogo name="Афиша Daily" /> Афише <em>Дейли</em></a></span>, <span class="nowrap"><a href={EXTERNAL_LINKS.alsHigimo} class="nowrap"><CompanyLogo name="ALS" /> Студии Лебедева</a></span> <span class="nowrap">и <a href={EXTERNAL_LINKS.rTop} class="nowrap"><CompanyLogo name="R-top" /> Эртопе</a></span>.
			</p>
			<p>
